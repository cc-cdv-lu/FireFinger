...
* added icons for chaptertype ([c4985d8](https://github.com/cc-cdv-lu/FireFinger/commit/c4985d8))
...
* completely removed 'VIEW' enum (to be replaced by ChapterType ENUM) ([e5d0df3](https://github.com/cc-cdv-lu/FireFinger/commit/e5d0df3))
...
* file service working now ([bbd3e78](https://github.com/cc-cdv-lu/FireFinger/commit/bbd3e78))
...
* fixed file reader ([b26460f](https://github.com/cc-cdv-lu/FireFinger/commit/b26460f))
...
* implemented win screen for simple-view ([fe07d51](https://github.com/cc-cdv-lu/FireFinger/commit/fe07d51))
* implemeted audio for simple view ([ccb3e7f](https://github.com/cc-cdv-lu/FireFinger/commit/ccb3e7f))
...
* more improvements ([6fe49ba](https://github.com/cc-cdv-lu/FireFinger/commit/6fe49ba))
...
* most of the initial stuff for simple view is set in place - needs logic now ([c54273a](https://github.com/cc-cdv-lu/FireFinger/commit/c54273a))
...
* now ignoring text case if simple type is active ([46c8390](https://github.com/cc-cdv-lu/FireFinger/commit/46c8390))
...
* selecting simple chapters randomly ([af7e6c1](https://github.com/cc-cdv-lu/FireFinger/commit/af7e6c1))
